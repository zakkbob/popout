...
document.body.setAttribute(
  ...
  function fixCollisions(obj) {
      ...
      //     let yOverlap = dragger.getBoundingClientRect().y - dragger1.getBoundingClientRect().y;
      //     let xOverlap = dragger.getBoundingClientRect().x - dragger1.getBoundingClientRect().x;
      //     if (!(Math.abs(yOverlap) < 200 && Math.abs(xOverlap) < 200)) return;
  
      //     if (Math.abs(yOverlap) < Math.abs(xOverlap)) {
      //         console.log(xOverlap);
      //         dragger1.style.left = dragger1.getBoundingClientRect().x - (200 - xOverlap) + "px";
      //     } else {
